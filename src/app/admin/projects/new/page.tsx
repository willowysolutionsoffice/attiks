    ...
    <div style={{ maxWidth: 840, margin: '0 auto' }}>
      ...
      <div className="admin-page-header">
        <div>
          ...
          <p className="admin-page-subtitle">Publish a new architectural masterpiece to the portfolio database</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="admin-table-wrap" style={{ padding: '2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem', marginBottom: '1.25rem' }}>
          <div className="admin-field">
            ...
            <input
              ...
              placeholder="e.g. Greenfield Tech Park"
          ...
          <div className="admin-field" style={{ gridColumn: '1 / -1' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
              <input
                ...
                className="admin-input"
                style={{ flex: 1 }}
                placeholder="/architecture.webp or /uploads/..."
        ...
        <div className="admin-field" style={{ marginBottom: '1.25rem' }}>
          ...
          <textarea
            ...
            placeholder="Detailed architectural description, climate orientation, spatial flow, and context..."
            rows={4}
        ...
        <div className="admin-field" style={{ marginBottom: '1.25rem' }}>
          ...
          <textarea
            className="admin-textarea"
            placeholder="Passive Cooling Courtyards&#10;High-Performance Double Glazing&#10;Contextual Timber Screens"
            rows={3}
